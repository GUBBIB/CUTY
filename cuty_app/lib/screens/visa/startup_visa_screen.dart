...
class StartupVisaScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.rocket_launch_outlined, size: 80, color: Colors.grey),
            const SizedBox(height: 16),
            Text("창업형 비자 로드맵 준비 중입니다.", style: GoogleFonts.poppins(fontSize: 16, color: Colors.grey)),
          ],
        ),
      ),
    );
